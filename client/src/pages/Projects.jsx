    ...
    return (
      <div>
        ...
        {!loading && projects.length > 0 && visibleProjects.length === 0 && (
          <EmptyState
            title={t('projects.allFilteredTitle')}
            hint={t('projects.allFilteredHint')}
          />
        )}
